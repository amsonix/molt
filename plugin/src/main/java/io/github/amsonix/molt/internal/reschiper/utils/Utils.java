package io.github.amsonix.molt.internal.reschiper.utils;
...
public class Utils {
    ...
    private static String replaceEach(String text, String[] searchList, String[] replacementList) {
        if (text == null || searchList == null || replacementList == null) {
            throw new IllegalArgumentException("text/searchList/replacementList must not be null");
        }
        if (searchList.length != replacementList.length) {
            throw new IllegalArgumentException(
                    "searchList/replacementList length mismatch: "
